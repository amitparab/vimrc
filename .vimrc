...
" Visual mode pressing * or # searchs for the current selection
...
" Deleting trailing white space on save, useful for some filetypes
...
" Pressing, ss will toggle an untoggle spell checking
map <leader>sn ]s
map <leader>sp [s
map <leader>sa zg
map <leader>s? z=
...
" Remove teh Windows ^M - when the encodings gets messed up
